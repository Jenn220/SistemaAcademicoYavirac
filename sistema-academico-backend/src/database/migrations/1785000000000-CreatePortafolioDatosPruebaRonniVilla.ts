    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`
            ...
            DECLARE
                ...
                v_id_usuario bigint;
            BEGIN
                -- 1. Crear/Actualizar el docente principal
                ...
                -- 3. Crear o actualizar usuario con hash '123456' ($2a$10$qtzW2ox1tH/P7f32NPTs4uNq5GxfYzpEKiUDLj9GOA8C8D3ft0i8q)
                ...
                -- 4. Asignar roles (COORDINADOR y DOCENTE)
                ...
                -- 9. Datos de prueba para portafolio

    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`
            ...
            BEGIN
                ...
                -- ACTIVIDADES ESTUDIANTE 1
                FOR i IN 0..3 LOOP
                    INSERT INTO public.vinculacion_actividad_estudiante (
                        id_vinculacion, fecha, hora_inicio, hora_fin, horas_total, actividades_realizadas, resultado_aprendizaje
                    ) VALUES (
                        v_id_vinculacion1, CURRENT_DATE - (i * 7)::integer, '08:00:00', '12:00:00', 4.0,
                        CASE i
                            WHEN 0 THEN 'Reunión de planificación con la comunidad'
                            WHEN 1 THEN 'Diagnóstico participativo de necesidades'
                            WHEN 2 THEN 'Ejecución de actividades planificadas'
                            WHEN 3 THEN 'Evaluación de impacto y retroalimentación'
                        END,
                        CASE i
                            WHEN 0 THEN 'Se establecieron objetivos y alcances'
                            WHEN 1 THEN 'Se identificaron necesidades de la comunidad'
                            WHEN 2 THEN 'Se ejecutaron actividades con participación activa'
                            WHEN 3 THEN 'Se recogieron evidencias y se evaluó el impacto'
                        END
                    );
                END LOOP;

                -- ACTIVIDADES ESTUDIANTE 28
                FOR i IN 0..3 LOOP
                    INSERT INTO public.vinculacion_actividad_estudiante (
                        id_vinculacion, fecha, hora_inicio, hora_fin, horas_total, actividades_realizadas, resultado_aprendizaje
                    ) VALUES (
                        v_id_vinculacion28, CURRENT_DATE - (i * 7)::integer, '09:00:00', '13:00:00', 4.0,
                        CASE i
                            WHEN 0 THEN 'Taller de sensibilización comunitaria'
                            WHEN 1 THEN 'Diseño de proyectos sociales'
                            WHEN 2 THEN 'Implementación de proyectos'
                            WHEN 3 THEN 'Evaluación de resultados'
                        END,
                        CASE i
                            WHEN 0 THEN 'Se sensibilizó a la comunidad sobre el proyecto'
                            WHEN 1 THEN 'Se diseñaron proyectos con enfoque participativo'
                            WHEN 2 THEN 'Se implementaron proyectos con éxito'
                            WHEN 3 THEN 'Se evaluaron resultados obtenidos'
                        END
                    );
                END LOOP;

                -- ASISTENCIA TUTOR VINCULACIÓN 1
                FOR i IN 0..2 LOOP
                    INSERT INTO public.vinculacion_asistencia_tutor (
                        id_vinculacion, fecha, hora_inicio, hora_fin, horas_total, actividad_realizada, observaciones
                    ) VALUES (
                        v_id_vinculacion1, CURRENT_DATE - (i * 14)::integer, '09:00:00', '11:00:00', 2.0,
                        CASE i
                            WHEN 0 THEN 'Visita de supervisión inicial'
                            WHEN 1 THEN 'Seguimiento de actividades'
                            WHEN 2 THEN 'Evaluación de avances'
                        END,
                        CASE i
                            WHEN 0 THEN 'Estudiante demostró compromiso y buena disposición'
                            WHEN 1 THEN 'Se observa progreso en actividades planificadas'
                            WHEN 2 THEN 'Proyecto avanza según lo planificado'
                        END
                    );
                END LOOP;

                -- ASISTENCIA TUTOR VINCULACIÓN 28
                FOR i IN 0..2 LOOP
                    INSERT INTO public.vinculacion_asistencia_tutor (
                        id_vinculacion, fecha, hora_inicio, hora_fin, horas_total, actividad_realizada, observaciones
                    ) VALUES (
                        v_id_vinculacion28, CURRENT_DATE - (i * 14)::integer, '10:00:00', '12:00:00', 2.0,
                        CASE i
                            WHEN 0 THEN 'Visita de supervisión inicial'
                            WHEN 1 THEN 'Seguimiento de actividades'
                            WHEN 2 THEN 'Evaluación de avances'
                        END,
                        CASE i
                            WHEN 0 THEN 'Estudiante muestra interés en el proyecto'
                            WHEN 1 THEN 'Actividades se ejecutan según lo planificado'
                            WHEN 2 THEN 'Se recomienda continuar con el proyecto'
                        END
                    );
                END LOOP;
                ...
                RAISE NOTICE '✅ DATOS DE VINCULACIÓN CREADOS EXITOSAMENTE';
                RAISE NOTICE '📌 Vinculación 1: ID %, Estudiante 9700000001, Docente 9800000046', v_id_vinculacion1;
                RAISE NOTICE '📌 Vinculación 28: ID %, Estudiante 9700000028, Docente 9800000483', v_id_vinculacion28;
                RAISE NOTICE '🔑 USUARIOS: estudiante.lote1@yavirac.edu.ec / estudiante.lote28@yavirac.edu.ec / docente.lote46@yavirac.edu.ec / docente.lote483@yavirac.edu.ec';

...
export class CreatePortafolioDatosPruebaRonniVilla1790500000000 implements MigrationInterface {
    name = 'CreatePortafolioDatosPruebaRonniVilla1790500000000';
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`
            ...
            DECLARE
                ...
                v_id_usuario bigint;
            BEGIN
                -- ========== FIX: Sincronizar secuencia de docente ==========
                PERFORM setval('docente_id_docente_seq', COALESCE((SELECT MAX(id_docente) FROM docente), 1));
                ...
                -- 2. Crear/actualizar usuario Ronni Villa con hash '123456'
                ...
                IF v_id_rol_coordinador IS NULL OR v_id_rol_docente IS NULL THEN
                    RAISE EXCEPTION 'Faltan roles (COORDINADOR, DOCENTE) en la tabla rol.';
                END IF;

                -- Roles para Ronni Villa: COORDINADOR + DOCENTE
                ...
                -- 5. Crear oferta asignatura propia para Ronni Villa
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        // Revertir el coordinador a NULL ANTES de borrar el docente
        await queryRunner.query(`
            UPDATE public.periodo_carrera
        ...
        await queryRunner.query(`
            ...
            WHERE id_usuario IN (
                ...
                WHERE correo IN ('rav.villa@yavirac.edu.ec')
            );
        `);
